...
const PRODUCTS = [
  {
    ...
    imagen_principal: { url: '/images/product-sofa.png', alt: 'Cubo' },
    animClass: 'rv',
  },
  {
    id: 'cama',
    ...
    imagen_principal: { url: '/images/product-cama.png', alt: 'Feather' },
    animClass: 'rv d1',
  },
  {
    id: 'luna',
    ...
    imagen_principal: { url: '/images/product-luna.png', alt: 'Metro' },
    animClass: 'rv d2',
  },
]
