...
const SalesProspector = lazy(() => import('./admin/sales/SalesProspector'))
      ...
      <AdminAuthProvider>
        ...
        <Routes>
          ...
          >
            ...
            <Route path="sales/prospector" element={<Suspense fallback={<AdminFallback />}><SalesProspector /></Suspense>} />
